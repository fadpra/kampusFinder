const daftarKampus = [
    ui = {
        ...
        profilSingkat: {
            ...
            terjemahan: "Kebenaran, Kejujuran, Keadilan",
            tahunBerdiri: 1849,
            kota: "Depok",
            provinsi: "Jawa Barat",
            tipe: "Negeri",
            ...
            luasKampus: ["Depok - 320 hektar", "Salemba - 15 hektar"],
            kemahasiswaan: {
    ...
    itb = {
        ...
        profilSingkat: {
          ...
          terjemahan: "Kemajuan dalam Keselarasan",
          tahunBerdiri: 1920,
          kota: "Bandung",
          provinsi: "Jawa Barat",
          tipe: "Negeri",
          ...
          fotoKampus: "https://paristech.fr/sites/default/files/styles/bandeau_haut/public/2023-10/adobestock_609569289_itb_bandung_sony_herdiana.jpeg?itok=zlrHTGTI",
          ...
          luasKampus: ["Ganesha - 28 hektar","Jatiangor - 45 hektar"],
          kemahasiswaan: {
    ...
    ugm = {
      ...
      profilSingkat: {
        ...
        terjemahan: "Locally Rooted, Globally Respected",
        tahunBerdiri: 1949,
        kota: "Yogyakarta",
        provinsi: "Yogyakarta",
        tipe: "Negeri",
        ...
        fotoKampus: "https://bakpiakukustugu.co.id/uploads/11/2023-11/ugm.jpeg",
        ...
        luasKampus: ["Yogyakarta - 360 hektar"],
        kemahasiswaan: {
...
const kampusID = params.get("id")

const kampusBanner = document.querySelector("#kampusBanner")
const kampusLogo = document.querySelector("#kampusLogo")
const kampusNama = document.querySelector("#kampusNama")
const kampusDeskripsi = document.querySelector("#kampusDeskripsi")

const kampusMotto = document.querySelector("#psMotto")
const kampusTerjemahan = document.querySelector("#psTerjemahan")
const kampusTahun = document.querySelector("#psTahun")
const kampusTipe = document.querySelector("#psTipe")
const kampusAkreditasi = document.querySelector("#psAkreditasi")
const kampusDosen = document.querySelector("#psDosen")
const kampusMahasiswa = document.querySelector("#psMahasiswa")
const kampusKontak = document.querySelector("#psKontak")
const kampusRanking = document.querySelector("#psRanking")
const kampusLuas = document.querySelector("#psLuasKampus")
const kampusKemahasiswaan = document.querySelector("#psKemahasiswaan")
const kampusFasilitas = document.querySelector("#psFasilitas")

const kampusJalurPenerimaan = document.querySelector("#pJalur")
const kampusCatatanPenerimaan = document.querySelector("#pCatatan")

const kampusFakultasDanProdi = document.querySelector("#fakultas")

daftarKampus.find(kampus => {
    if(kampus.id == kampusID){
        kampusBanner.src = kampus.profilSingkat.fotoKampus
        kampusLogo.src = kampus.profilSingkat.logo
        
        if(screen.width > 600){
            kampusNama.innerHTML = `Profil <br> ${kampus.profilSingkat.nama}`
        } else {
            kampusNama.innerHTML = `Profil ${kampus.profilSingkat.nama}`
        }
        
        kampusDeskripsi.innerHTML = kampus.profilSingkat.deskripsi
    
        document.querySelector("#psNama").innerHTML = `Nama:  <b>${kampus.profilSingkat.nama}</b>`
        kampusMotto.innerHTML = `Motto:  <b>${kampus.profilSingkat.motto}</b>`
        kampusTerjemahan.innerHTML = `Terjemahan:  <b>${kampus.profilSingkat.terjemahan}</b>`
        kampusTahun.innerHTML = `Tahun Berdiri:  <b>${kampus.profilSingkat.tahunBerdiri}</b>`
        kampusTipe.innerHTML = `Tipe:  <b>Perguruan Tinggi ${kampus.profilSingkat.tipe}</b>`
        kampusAkreditasi.innerHTML = `Akreditasi:  <b>${kampus.profilSingkat.akreditasi}</b>`
        kampusDosen.innerHTML = `Jumlah Dosen:  <b>${kampus.profilSingkat.jumlahDosen}</b>`
        kampusMahasiswa.innerHTML = `Jumlah Mahasiswa:  <b>${kampus.profilSingkat.jumlahMahasiswa}</b>`
    
        document.querySelector("#alamat").innerHTML = `Alamat: <b>${kampus.profilSingkat.kontak.alamat}<b>`
        document.querySelector("#telepon").innerHTML = `Telepon: <b>${kampus.profilSingkat.kontak.telepon}<b>`
        document.querySelector("#email").innerHTML = `Email: <b>${kampus.profilSingkat.kontak.email}<b>`
        document.querySelector("#website").innerHTML = `Website: <b>${kampus.profilSingkat.kontak.website}<b>`
    
        document.querySelector("#qsRank").innerHTML = `Ranking QSWorld: <b>${kampus.profilSingkat.ranking.qsWorld}</b>`
        document.querySelector("#asiaRank").innerHTML = `Ranking Asia: <b>${kampus.profilSingkat.ranking.asia}</b>`
        document.querySelector("#indoRank").innerHTML = `Ranking Nasional: <b>${kampus.profilSingkat.ranking.nasional}</b>`
    
        kampus.profilSingkat.luasKampus.forEach(tempat => {
            const lokasiKampus = document.createElement("h3")
            lokasiKampus.classList.add("luasKampus")
            lokasiKampus.innerHTML = `<b>${tempat}</b>`
            kampusLuas.appendChild(lokasiKampus)
        })

        document.querySelector("#psHimpunan").innerHTML = `Himpunan: <b>${kampus.profilSingkat.kemahasiswaan.himpunan}</b>`
        document.querySelector("#psUKM").innerHTML = `Himpunan: <b>${kampus.profilSingkat.kemahasiswaan.ukm}</b>`
        
        kampus.profilSingkat.kemahasiswaan.prestasi.forEach(prestasi => {
            const newPrestasi = document.createElement("h3")
            newPrestasi.classList.add("prestasi")
            newPrestasi.innerHTML = `<b>- ${prestasi}</b>`
            document.querySelector("#psPrestasi").appendChild(newPrestasi)
        })

        kampus.profilSingkat.fasilitas.forEach(fasilitas => {
            const newFasilitas = document.createElement("h3")
            newFasilitas.classList.add("fasilitas")
            newFasilitas.innerHTML = `<b>- ${fasilitas}</b>`
            kampusFasilitas.appendChild(newFasilitas)
        })

        document.querySelector("#pendaftar").innerHTML = `Pendaftar Kampus Tahun ${kampus.penerimaan.tahunData}: <b>${kampus.penerimaan.totalPendaftar}</b>`
        document.querySelector("#dayaTampung").innerHTML = `Daya Tampung Kampus Tahun ${kampus.penerimaan.tahunData}: <b>${kampus.penerimaan.dayaTampungTotal}</b>`

        kampus.penerimaan.jalurMasuk.forEach(jalur => {
            const newJalur = document.createElement("h3")
            newJalur.classList.add("jalur")
            newJalur.innerHTML = `${jalur.nama}: <b>${jalur.deskripsi}</b>`
            kampusJalurPenerimaan.appendChild(newJalur)
        })

        kampus.penerimaan.catatan.forEach(catatan => {
            const newCatatan = document.createElement("h3")
            newCatatan.classList.add("pCatatan2")
            newCatatan.innerHTML = `<b>${catatan}</b>`
            kampusCatatanPenerimaan.appendChild(newCatatan)
        })

        kampus.fakultasDanProdi.forEach(rumpun => {
            //nama rumpun
            const newRumpun = document.createElement("div")
            newRumpun.classList.add("rumpun")
            const namaRumpun = document.createElement("h3")
            namaRumpun.classList.add("namaRumpun")
            namaRumpun.innerHTML = rumpun.rumpun
            newRumpun.appendChild(namaRumpun)

            rumpun.fakultas.forEach(fakultas => {
                const newFakultas = document.createElement("div")
                newFakultas.classList.add("fakultas")
                const fakultasNama = document.createElement("h3")
                fakultasNama.classList.add("namaFakultas")
                fakultasNama.innerHTML = fakultas.namaFakultas
                newFakultas.appendChild(fakultasNama)

                // fakultas.namaFakultas.prodi.forEach(prodi => {
                //     const newProdi = document.createElement("div")
                //     newProdi.classList.add("prodi")
                //     const namaProdi = document.createElement("h3")
                //     namaProdi.classList.add("namaProdi")
                //     namaProdi.innerHTML = prodi.namaProdi
                //     newProdi.appendChild(namaProdi)
                //     newFakultas.appendChild(newProdi)
                // })
                fakultas.prodi.forEach(prodi => {
                    ...
                    const namaProdi = document.createElement("h3")
                    namaProdi.classList.add("namaProdi")
                    namaProdi.innerHTML = `Program Studi ${prodi.namaProdi}`
                    newProdi.appendChild(namaProdi)

                    const newDesc = document.createElement("h3")
                    newDesc.classList.add("prodiInfo")
                    newDesc.innerHTML = `Deskripsi: <b>${prodi.deskripsi}</b>`
                    newProdi.appendChild(newDesc)

                    if(prodi.nilaiSNBP && prodi.nilaiSNBT){
                        const newSNBP = document.createElement("h3")
                        newSNBP.classList.add("prodiInfo")
                        newSNBP.innerHTML = `Nilai Rata-Rata SNBP: <b>${prodi.nilaiSNBP}</b>`
                        newProdi.appendChild(newSNBP)

                        const newSNBT = document.createElement("h3")
                        newSNBT.classList.add("prodiInfo")
                        newSNBT.innerHTML = `Nilai Rata-Rata SNBT: <b>${prodi.nilaiSNBT}</b>`
                        newProdi.appendChild(newSNBT)
                    } else if(prodi.nilaiMinimal) {
                        const newMinimal = document.createElement("h3")
                        newMinimal.classList.add("prodiInfo")
                        newMinimal.innerHTML = `Nilai Rata-Rata Minimal: <b>${prodi.nilaiMinimal}</b>`
                        newProdi.appendChild(newMinimal)
                    }

                    const newPendaftar = document.createElement("h3")
                    newPendaftar.classList.add("prodiInfo")
                    newPendaftar.innerHTML = `Jumlah Pendaftar: <b>${prodi.pendaftar}</b>`
                    newProdi.appendChild(newPendaftar)

                    const newDayaTampung = document.createElement("h3")
                    newDayaTampung.classList.add("prodiInfo")
                    newDayaTampung.innerHTML = `Daya Tampung: <b>${prodi.dayaTampung}</b>`
                    newProdi.appendChild(newDayaTampung)

                    const newKeketatan = document.createElement("h3")
                    newKeketatan.classList.add("prodiInfo")
                    newKeketatan.innerHTML = `Keketatan: <b>${prodi.keketatan}</b>`
                    newProdi.appendChild(newKeketatan)

                    newFakultas.appendChild(newProdi)
                })

                newRumpun.appendChild(newFakultas)
            })

            document.querySelector(".fpsInfo").appendChild(newRumpun)
        })

        kampus.biaya.kategori.forEach(kategori => {
            const newKategori = document.createElement("div")
            newKategori.classList.add("info2")

            const info3Title = document.createElement("h3")
            info3Title.classList.add("info3Title")
            info3Title.innerHTML = `<b>${kategori.nama}</b>`

            const info3Desc = document.createElement("h3")
            info3Desc.classList.add("info3Title")
            info3Desc.innerHTML = kategori.deskripsi

            const info3Kis = document.createElement("h3")
            info3Kis.classList.add("info3Title")
            info3Kis.innerHTML = kategori.kisaran

            newKategori.appendChild(info3Title)
            newKategori.appendChild(info3Desc)
            newKategori.appendChild(info3Kis)

            document.querySelector(".bInfo").appendChild(newKategori)
        })

        
        if(kampus.biaya.biayaLain) {
            kampus.biaya.biayaLain.forEach(biaya => {
                const newKategori = document.createElement("div")
                newKategori.classList.add("info2")
    
                const info3Title = document.createElement("h3")
                info3Title.classList.add("info3Title")
                info3Title.innerHTML = `<b>${biaya.nama}</b>`
    
                const info3Desc = document.createElement("h3")
                info3Desc.classList.add("info3Title")
                info3Desc.innerHTML = biaya.deskripsi
    
                const info3Kis = document.createElement("h3")
                info3Kis.classList.add("info3Title")
                info3Kis.innerHTML = biaya.kisaran
        ...
        const newBeasiswa = document.createElement("div")
        newBeasiswa.classList.add("info2")
        const beasiswaTitle = document.createElement("h3")
        beasiswaTitle.innerHTML = `<b>Jenis Beasiswa</b>`
        newBeasiswa.appendChild(beasiswaTitle)

        kampus.biaya.beasiswa.forEach(beasiswa => {
            const info3Desc = document.createElement("h3")
            info3Desc.classList.add("info3Title")
            info3Desc.innerHTML = beasiswa

            newBeasiswa.appendChild(info3Desc)
            document.querySelector(".bInfo").appendChild(newBeasiswa)
        })

        if(kampus.biaya.catatan){
            const newCatatan = document.createElement("div")
            newCatatan.classList.add("info2")
            const catatanTitle = document.createElement("h3")
            catatanTitle.innerHTML = `<b>Catatan</b>`
            newCatatan.appendChild(catatanTitle)

            kampus.biaya.catatan.forEach(catatan => {
                const info3Desc = document.createElement("h3")
                info3Desc.classList.add("info3Title")
                info3Desc.innerHTML = catatan

                newCatatan.appendChild(info3Desc)
                document.querySelector(".bInfo").appendChild(newCatatan)
        })
        }
    }
})

const profilSingkat = document.querySelector("#profilSingkat")
const psInfo = document.querySelector(".psInfo")

profilSingkat.addEventListener("click",() =>{
    psInfo.classList.toggle("displayPS")
})

const penerimaan = document.querySelector("#penerimaan")
const pInfo = document.querySelector(".pInfo")

penerimaan.addEventListener("click",() =>{
    pInfo.classList.toggle("displayP")
})

const fakultasProdi = document.querySelector("#fakultas")
const fpsInfo = document.querySelector(".fpsInfo")

fakultasProdi.addEventListener("click",() => {
    fpsInfo.classList.toggle("displayFPS")
})

const biaya = document.querySelector("#biaya")
const bInfo = document.querySelector(".bInfo")

biaya.addEventListener("click",() => {
    bInfo.classList.toggle("displayB")
})
